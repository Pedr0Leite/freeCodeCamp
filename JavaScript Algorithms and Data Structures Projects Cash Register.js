...
//   var totalCid = cid.reduce(function(acc,next){ //this is what is inside the cash register
//     return acc + next[1]; //This is grabbing the value of the 2D array, in this case, the number.
//   }, 0.0)   // The 2D Array
//
//   if(totalCid < change){
...
//   return result.length > 0 && change === 0 ? result : 'insufficient Funds'; //after the && means if the change is 0 return result else a string.
// }
